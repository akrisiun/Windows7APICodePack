...
namespace MS.WindowsAPICodePack.Internal
{
    ...
    public sealed class PropVariant : IDisposable
    {
            ...
            lock (_padlock)
            {
                ...
                if (!_cache.TryGetValue(type, out action))
                {
                    ...
                    { // if the method was not found, throw.
                        throw new ArgumentException("PropVariantTypeNotSupported");  // LocalizedMessages.
                    }
        ...
        public PropVariant(string value)
        {
            if (value == null)
            {
                throw new ArgumentException("PropVariantNullString {0}", "value");  // LocalizedMessages.
            }
        ...
        private Array GetVector<T>()
        {
            ...
            {
                throw new InvalidCastException("PropVariantUnsupportedType"); // LocalizedMessages.
            }
        ...
        private static Array CrackSingleDimSafeArray(IntPtr psa)
        {
            ...
            if (cDims != 1)
                throw new ArgumentException("PropVariantMultiDimArray {0}", "psa"); // LocalizedMessages.
