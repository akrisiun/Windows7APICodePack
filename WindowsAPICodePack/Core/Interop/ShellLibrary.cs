...
namespace WindowsAPICodePack.Shell
{
    ...
    public sealed class ShellLibrary // : ShellContainer, IList<ShellFileSystemFolder>
    {
        ...
        private object // INativeShellLibrary 
                nativeShellLibrary;
        ...
        private ShellLibrary(
            object // IKnownFolder 
            sourceKnownFolder, bool isReadOnly)
            : this()
        {
            //Debug.Assert(sourceKnownFolder != null);

            //// Keep a reference locally
            //knownFolder = sourceKnownFolder as IKnownFolder;
            ...
            : this()
        {
            ...
            {
                throw new ArgumentException("ShellLibraryEmptyName {0}", "libraryName");    // LocalizedMessages.
            }
        ...
        public ShellLibrary(string libraryName,
            object // IKnownFolder 
                sourceKnownFolder, bool overwrite)
            : this()
        {
            //if (string.IsNullOrEmpty(libraryName))
            //{
            ...
            : this()
        {
            ...
            {
                throw new DirectoryNotFoundException("ShellLibraryFolderNotFound"); // v LocalizedMessages.
            }
        ...
        public Guid LibraryTypeId
        {
            get
            {
                Guid folderTypeGuid = default(Guid);
                //nativeShellLibrary.GetFolderType(out folderTypeGuid);
        ...
        //        }
        //    }
        //    throw new ArgumentOutOfRangeException("folderTypeGuid", "ShellLibraryInvalidFolderType"); // LocalizedMessages.
        //}
        ...
        public string DefaultSaveFolder
        {
            ...
            set
            {
                ...
                {
                    throw new DirectoryNotFoundException("ShellLibraryDefaultSaveFolderNotFound"); // LocalizedMessages.
                }
        ...
        public void Add(string folderPath)
        {
            if (!Directory.Exists(folderPath))
            {
                throw new DirectoryNotFoundException("ShellLibraryFolderNotFound"); // LocalizedMessages.
            }
